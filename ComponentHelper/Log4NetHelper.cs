...
namespace SpecFlowBDDAutomationFramework.ComponentHelper
{
    public class Log4NetHelper
    {
        ...
        public static ILog GetLogger(Type type)
        {
            ...
            log4net.Config.BasicConfigurator.Configure(_consoleAppender, _fileAppender, _rollingFileAppender);
            _logger = LogManager.Log(type);
            return _logger;
        ...
        public static ILog GetXmlLogger(Type type)
        {
            ...
            _xmlLogger = LogManager.Log(type);
            return _xmlLogger;
        }
